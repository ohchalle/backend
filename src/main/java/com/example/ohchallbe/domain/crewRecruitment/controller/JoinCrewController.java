...
public class JoinCrewController {
    ...
    public ResponseEntity<AcceptedResponseDto> acceptDetailPageJoinCrewApply(@AuthenticationPrincipal UserDetailsImpl userDetails, @PathVariable Long crewRecruitmentId , @RequestParam(value = "applyerEmail") String applyerEmail ) {
        String userEmail = userDetails.getUser().getEmail();
